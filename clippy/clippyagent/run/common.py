...
More on union types: [link=https://clippybot.com/latest/usage/cl_tutorial/#union-types]https://clippybot.com/latest/usage/cl_tutorial/#union-types[/link]
"""

_SETTING_ERROR_HINTS = """
[red][bold]Hints:[/bold][/red]
Run `clippybot <subcommand> --help` for usage examples.
...
class BasicCLI:
    def __init__(
        ...
        *,
        ...
        """This class implements a basic CLI for clippybot. It is based on pydantic-settings, i.e., takes
...
def save_predictions(traj_dir: Path, instance_id: str, result: AgentRunResult):
    """Save predictions in a file readable by clippybot-bench"""
