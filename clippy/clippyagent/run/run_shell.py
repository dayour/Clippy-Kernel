"""[cyan][bold]Run clippybot in semi-interactive mode.[/bold][/cyan]
...
def run_from_cli(args: list[str] | None = None):
    ...
    env = clippybotenv.from_config(env_config)
    ...
    run_shell = RunShell(env, agent, problem_statement=problem_statement, output_dir=Path.home() / "clippybot_shell")
    run_shell.run()
