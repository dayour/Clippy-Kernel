...
It might be easiest to simply look at some of our example configurations in the [config dir](https://github.com/clippybot/clippybot/tree/main/config).
...
::: clippybot.agent.agents.RetryAgentConfig

::: clippybot.agent.agents.DefaultAgentConfig