...
::: clippybot.agent.models.GenericAPIModelConfig
    options:
        heading_level: 3

::: clippybot.agent.models.RetryConfig
    options:
        heading_level: 3
...
::: clippybot.agent.models.HumanModel
    options:
        heading_level: 3

::: clippybot.agent.models.HumanThoughtModel
    options:
        heading_level: 3

## Replay model for testing and demonstrations

::: clippybot.agent.models.ReplayModel
    options:
        heading_level: 3
