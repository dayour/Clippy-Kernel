...
> Does clippybot support multimodal models and images?

Yes! clippybot supports vision-capable models that can process images from GitHub issues. Use `--config config/default_mm_with_images.yaml` and specify a multimodal model like Claude Sonnet 4 or GPT-4o. See the [multimodal guide](usage/multimodal.md) for details.
...
There are also some config example in our [config folder](https://github.com/clippybot/clippybot/tree/main/config).

## Configuring clippybot

> How can I change the demonstrations given to clippybot?
...
You're probably most interested in the `*.traj` files, which contain complete records of clippybot's thought process and actions. See [output files](usage/trajectories.md) for more information.

## Anything else?

> I have a question/bug report/feature request...

Please open a [github issue!](https://github.com/clippybot/clippybot/issues)!
