...
!!! abstract "Setting up models"
    This page shows how you can set up your LM with clippybot
...
!!! warning "Message types"
    ...
    See [#957](https://github.com/clippybot/clippybot/issues/957) for more information.
...
* If you get `Error code: 404`, please check your configured keys, in particular
  ...
  Also see [this issue](https://github.com/clippybot/clippybot/issues/467)
  for reference.
