...
def test_is_github_repo_url():
    assert _is_github_repo_url("https://github.com/clippybot/clippybot")
    assert _is_github_repo_url("https://github.com/clippybot/clippybot/anything")
    assert _is_github_repo_url("github.com/clippybot/clippybot/anything")
    assert not _is_github_repo_url("")
    assert not _is_github_repo_url("/path/to/file")


def test_parse_gh_repo_url():
    assert _parse_gh_repo_url("https://github.com/clippybot/clippybot") == ("clippybot", "clippybot")
    assert _parse_gh_repo_url("github.com/clippybot/clippybot") == ("clippybot", "clippybot")
    assert _parse_gh_repo_url("github.com/clippybot/clippybot/asdfjsdfg") == ("clippybot", "clippybot")
    assert _parse_gh_repo_url("git@github.com/clippybot/clippybot/asdfjsdfg") == ("clippybot", "clippybot")
...
def test_parse_gh_issue_url():
    url = "https://github.com/clippybot/clippybot/issues/43"
    owner, repo, no = _parse_gh_issue_url(url)
    assert owner == "clippybot"
    assert repo == "clippybot"
    assert no == "43"
...
def test_is_from_github_url():
    ...
    assert _is_github_issue_url("https://github.com/clippybot/clippybot/issues/43")
