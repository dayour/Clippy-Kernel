...
1. Create a demo from a yaml file containing actions (can also be created from a trajectory file with [green]clippybot run traj-to-demo[/green]).
...
[green]clippybot run replay --traj_path mytraj.traj[/green]

Replay a demo file:

[green]clippybot run replay --traj_path mydemo.demo.yaml[/green]
"""
...
class RunReplay:
    ...
    def _get_env(self) -> clippybotenv:
        return clippybotenv(
