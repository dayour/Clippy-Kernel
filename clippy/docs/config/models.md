...
Prompt caching makes clippybot several times more affordable. While this is done automatically for models like `gpt-4o`,
...
!!! warning "Other history processors"
    ...
    you can combine as done [here](https://github.com/clippybot/clippybot/blob/main/config/clippybot_heavy.yaml).
...
Therefore, you can only run two parallel instances of clippybot with [`run-batch`](../usage/batch_mode.md) per key.
...
See [this issue in litellm](https://github.com/BerriAI/litellm/issues/8984) and and [clippybot PR #1035](https://github.com/clippybot/clippybot/issues/1035)
for omore information.
Since [#1036](https://github.com/clippybot/clippybot/pull/1036) you can also manually set the maximum output tokens and override the information
from `litellm`.
...
We also provide models for testing clippybot without spending any credits
