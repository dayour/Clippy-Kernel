...
This section of the documentation talks about the architecture and research goals of [clippybot](#clippybot).

## clippybot <a name="clippybot"></a>

clippybot turns LMs (e.g. GPT-4) into software engineering agents that can fix issues in GitHub repositories.

On [clippybot-bench](https://github.com/clippybot-bench/clippybot-bench), clippybot resolves **12.29%** of issues, achieving the state-of-the-art performance on the full test set.
...
clippybot is built and maintained by researchers from Princeton University.
...
A longer lecture touching on the project's motivation, research findings, as well as providing a hands-on tutorial on how to install, use, and configure clippybot is provided here:

<iframe width="560" height="315" src="https://www.youtube.com/embed/d9gcXpiiDao" title="NeurIPS Hacker Cup AI: clippybot" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
```bibtex
@inproceedings{yang2024clippybot,
...
## clippybot <span class="enigma">EnIGMA</span> <a name="enigma"></a>

!!! warning "Compatibility"
    clippybot <span class="enigma">EnIGMA</span> is currently only available for clippybot v0.7.0.

clippybot <span class="enigma">EnIGMA</span> adds advanced **offensive cybersecurity capabilities**.
...
We accomplish our results by extending the [ACIs](../background/aci.md) concept first introduced in clippybot, to the cybersecurity domain. We establish the novel [**Interactive Agent Tools** (IATs)](https://clippybot.com/0.7/background/iat/) concept, which enables our agent to use interactive tools such as a debugger, in a multitasking way such that the agent still has access to the main shell while using the debugger.

We also use a new **Summarizer** concept integrated into the agent to deal with long context. Read more about our different summarizers [here](https://clippybot.com/0.7/config/summarizers/).
