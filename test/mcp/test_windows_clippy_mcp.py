...
class TestClippyMCPConfig:
    ...
    def test_basic_config_creation(self):
        ...
        config = ClippyMCPConfig(clippy_executable_path="/path/to/clippy.exe", server_name="test-clippy")
    ...
    def test_config_with_azure_integration(self):
        ...
        azure_kv = AzureKeyVaultConfig(
            vault_url="https://test-vault.vault.azure.net/", tenant_id="test-tenant", client_id="test-client"
        )

        entra_id = EntraIDConfig(tenant_id="test-tenant", client_id="test-client", client_secret="test-secret")
...
class TestAzureKeyVaultConfig:
    ...
    def test_basic_keyvault_config(self):
        ...
        config = AzureKeyVaultConfig(
            vault_url="https://test.vault.azure.net/", tenant_id="tenant-123", client_id="client-456"
        )
...
class TestEntraIDConfig:
    ...
    def test_basic_entra_config(self):
        ...
        config = EntraIDConfig(tenant_id="tenant-123", client_id="client-456", client_secret="secret-789")
    ...
    def test_custom_scopes(self):
        ...
        config = EntraIDConfig(tenant_id="tenant-123", client_id="client-456", scopes=custom_scopes)
...
class TestWindowsClippyMCPClient:
    ...
    async def test_initialize_azure_auth_no_config(self, mock_import):
        ...
        # No Entra ID config
        client = WindowsClippyMCPClient(ClippyMCPConfig(clippy_executable_path="/path/to/clippy.exe"))
...
class TestVSCodeExtensionGeneration:
    ...
    def test_create_vscode_extension_files(self):
        ...
        config = ClippyMCPConfig(clippy_executable_path="/path/to/clippy.exe", vscode_extension_port=9876)
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert (
                package_data["contributes"]["configuration"]["properties"]["ag2-clippy.serverPort"]["default"] == 9876
            )
...
class TestIntegrationScenarios:
    ...
    def test_full_config_integration(self):
        ...
        config = ClippyMCPConfig(
            ...
            azure_key_vault=azure_kv,
            entra_id=entra_id,
            shared_llm_keys={"openai": "sk-test-key", "anthropic": "ant-test-key"},
            llm_key_vault_mapping={"openai": "openai-api-key", "anthropic": "anthropic-api-key"},
    ...
    async def test_memory_and_key_management_workflow(self):
        ...
        config = ClippyMCPConfig(
            clippy_executable_path="/path/to/clippy.exe",
            shared_llm_keys={"openai": "sk-real-key", "anthropic": "ant-real-key"},
            memory_engine_enabled=True,
        )
...
class TestLiveIntegration:
    ...
    async def test_create_clippy_toolkit_live(self):
        ...
        config = ClippyMCPConfig(clippy_executable_path="windows-clippy-mcp", server_name="live-test")
