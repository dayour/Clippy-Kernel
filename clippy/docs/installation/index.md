...
<div class="grid cards">
  <a href="source/" class="nav-card-link">
    <div class="nav-card">
      ...
      <p class="nav-card-description">Install clippybot locally from source using pip. This is the default option.</p>
    </div>
  </a>
  ...
  <a href="changelog/" class="nav-card-link">
    <div class="nav-card">
      ...
      <p class="nav-card-description">See what's new in clippybot!</p>
    </div>
  </a>
</div>
