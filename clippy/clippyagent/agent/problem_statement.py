...
class clippybotbenchMultimodalProblemStatement(_BuiltinProblemStatementBase):
    text: str
    ...
    type: Literal["clippybot_bench_multimodal"] = "clippybot_bench_multimodal"
    """Discriminator for (de)serialization/CLI. Do not change."""
    ...
    def __repr__(self) -> str:
        ...
        return f"clippybotbenchMultimodalProblemStatement(id={self.id}, text={self.text[:30]}..., images={n_images})"
...
def problem_statement_from_simplified_input(
    *, input: str, type: Literal["text", "text_file", "github_issue", "clippybot_bench_multimodal"]
) -> ProblemStatementConfig:
    ...
    elif type == "clippybot_bench_multimodal":
        return clippybotbenchMultimodalProblemStatement(text=input)
    else:
