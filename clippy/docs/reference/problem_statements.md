...
With `clippybot run`, you can specify the problem statement type with the `--problem-statement` flag.
For example:
...
All of these classes are defined in `clippybot.agent.problem_statement`.

::: clippybot.agent.problem_statement.problem_statement_from_simplified_input
    options:
        show_root_full_path: false
        show_bases: false

::: clippybot.agent.problem_statement.TextProblemStatement
    options:
        show_root_full_path: false
        show_bases: false


::: clippybot.agent.problem_statement.FileProblemStatement
    options:
        show_root_full_path: false
        show_bases: false

::: clippybot.agent.problem_statement.GithubIssue
    options:
        show_root_full_path: false
        show_bases: false

::: clippybot.agent.problem_statement.EmptyProblemStatement
    options:
        show_root_full_path: false
        show_bases: false
