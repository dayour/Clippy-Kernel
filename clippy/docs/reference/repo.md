...
With `clippybot run`, you can specify the repository type with the `--env.repo` flag.
For example:
...
All of these classes are defined in `clippybot.environment.repo`.

::: clippybot.environment.repo.PreExistingRepoConfig
    options:
        show_root_full_path: false
        show_bases: false

::: clippybot.environment.repo.LocalRepoConfig
    options:
        show_root_full_path: false
        show_bases: false

::: clippybot.environment.repo.GithubRepoConfig
    options:
        show_root_full_path: false
        show_bases: false

::: clippybot.environment.repo.repo_from_simplified_input
    options:
        show_root_full_path: false
        show_bases: false
