...
* [User guides](index.md): This covers selected topics in more detail, for example
    * What are all the different [subcommands](cli.md) of `clippybot`?
    * How to [configure clippybot](../config/index.md)?
    * What's the main [architecture](../background/architecture.md) of clippybot?
