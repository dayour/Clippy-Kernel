...
* If your docker installation uses a different socket, you might have to symlink them, see [this command for example](https://github.com/clippybot/clippybot/issues/20#issuecomment-2047506005)
...
versions. Just because an image has the `latest` tag (e.g., `clippybot/clippybot-run:latest`) does not mean that it will auto-update. Please run
`docker pull clippybot/clippybot-run:latest` to make sure you actually have the most recent version!

Any remaining issues? Please [open a GitHub issue](https://github.com/clippybot/clippybot/issues/new/choose)!
