...
With clippybot, these tools are organized in _tool bundles_.
...
For example, for the classical clippybot tools, we extract the working directory and the currently open file like so:
