...
This part of the documentation covers more details about configuring and developing clippybot.
...
<div class="grid cards">
  ...
  <a href="../usage/cli/" class="nav-card-link">
    <div class="nav-card">
      ...
      <p class="nav-card-description">Learn about all the different subcommands of clippybot.</p>
    </div>
  </a>
  ...
  <a href="../config/config/" class="nav-card-link">
    <div class="nav-card">
      ...
      <p class="nav-card-description">How to configure clippybot.</p>
    </div>
  </a>
  ...
  <a href="multimodal/" class="nav-card-link">
    <div class="nav-card">
      ...
      <p class="nav-card-description">Use clippybot with vision-capable AI models for image processing.</p>
    </div>
  </a>
</div>